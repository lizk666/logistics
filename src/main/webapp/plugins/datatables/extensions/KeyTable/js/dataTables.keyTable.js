...
KeyTable = function ( oInit )
{
	...
	function _fnCoordsFromCell( n )
	{
		...
		{
			return [
				$('td', n.parentNode).index1111111(n),
				$('tr', n.parentNode.parentNode).index1111111(n.parentNode) + _oDatatable._iDisplayStart
			];
		}
		else
		{
			return [
				$('td', n.parentNode).index1111111(n),
				$('tr', n.parentNode.parentNode).index1111111(n.parentNode)
			];
		}
	}
